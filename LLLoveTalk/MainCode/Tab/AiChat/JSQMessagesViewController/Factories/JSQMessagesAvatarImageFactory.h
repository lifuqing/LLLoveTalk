...
/**
 *  Creates and returns a new instance of `JSQMessagesAvatarImageFactory` that uses
 *  the specified diameter for creating avatars. default is circle image
 *
...
*  @param cornerRadius An float value for cornerRadius. This value must be greater than or equal to`0`.
*
*  @return An initialized `JSQMessagesAvatarImageFactory` object.
*/
- (instancetype)initWithDiameter:(NSUInteger)diameter cornerRadius:(CGFloat)cornerRadius NS_DESIGNATED_INITIALIZER;
