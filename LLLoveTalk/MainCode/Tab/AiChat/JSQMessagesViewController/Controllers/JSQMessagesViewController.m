...
//    self.toolbarHeightConstraint.constant = self.inputToolbar.preferredDefaultHeight;
    ...
    self.inputToolbar.autoresizingMask = UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleTopMargin;
        ...
        if (avatarImageDataSource != nil) {
            ...
            if (avatarImage == nil) {
                if (avatarImageUrl.length > 0) {
                    [cell.avatarImageView sd_setImageWithURL:[NSURL URLWithString:avatarImageUrl] placeholderImage:[avatarImageDataSource avatarPlaceholderImage]];
    ...
    [UIView animateWithDuration:animationDuration
                     ...
                     animations:^{
                         ...
                         [self jsq_setCollectionViewInsetsTopValue:insets.top
                                                       bottomValue:CGRectGetHeight(keyboardEndFrame) + insets.bottom - SafeBottomAreaHeight];
                         self.inputToolbar.transform = CGAffineTransformMakeTranslation(0, -keyboardH + SafeTabBarHeight);
                     }
                     completion:nil];
}
...
- (void)jsq_didReceiveKeyboardWillHideNotification:(NSNotification *)notification {
    ...
    [UIView animateWithDuration:duration delay:0 options:options animations:^{
        ...
        const UIEdgeInsets insets = self.additionalContentInset;
        [self jsq_setCollectionViewInsetsTopValue:insets.top
                                      bottomValue:CGRectGetHeight(self.inputToolbar.frame) + insets.bottom];
    } completion:nil];
}
@end
